...
- I(1). Introduction
  ...
  - 3. The Vision: A Global, Visual, Compositional Language
...
- II(2). Structural Problems of Phonetic Languages
  ...
  - 5. Sound-Based Writing in the Internet Era
  
- III(3). The Hidden Inequality Inside English
  - 1. English as Two Languages
  - 2. STEM English as a “Foreign Language”
  - 3. Class-Based Exposure Differences
  - 4. Scientific Terminology as Gatekeeping
  - 5. Why English Is Not a Neutral Scientific Medium
...
- V(5). The Internet Age: Why Meaning-Based Writing Scales Better
  - 1. Stability of Meaning vs. Instability of Sound
  - 2. Interoperability Without Translation
  - 3. Universal Scientific Artifacts
  - 4. Precedents in Emoji and Symbolic Systems
  - 5. Unified Symbols + Local Pronunciation

- VI(6). Design Principles for the Universal Language
  ...
  - 5. Retaining Arabic Numerals and Existing Scientific Symbols
  - 6. Replacing Arbitrary Letters with Meaning-Bearing Operators
  - 7. Semantic Evolution

- VII(7). Pronunciation Architecture
  - 1. Baseline Pronunciation
  - 2. Reference, Not Requirement
  - 3. Local Freedom
  - 4. Avoiding Ambiguity
  - 5. International Registry for Baseline Pronunciations
...
- IX(9). Symbol Governance and Global Standardization
  ...
  - 4. Ensuring Cultural Neutrality
  - 5. Open-Source, Publicly Accessible Standards

- X(10). Learning Ecosystem and Global Adoption Strategy
  - 1. Interactive Tutorials and Educational Games
  - 2. Culturally Neutral Materials
  - 3. Modular Curricula
  - 4. Integration with STEM Education
  - 5. Adoption as a Second or Third Language
